...
func main() {
	...
	r.HandleFunc("/api/project/{project}/overview/logs/ws", a.Auth(a.OverviewLogsWebSocket)).Methods(http.MethodGet)
	...
	r.HandleFunc("/api/project/{project}/app/{app}/logs/stream", a.Auth(a.LogsStream)).Methods(http.MethodGet)
