...
var QUERIES = []Query{
	...
	qDB("pg_wal_throughput", `rate(pg_wal_current_lsn[$RANGE]) or rate(pg_wal_receive_lsn[$RANGE])`),
	qDB("pg_wal_receive_lsn", `pg_wal_receive_lsn`),
	qDB("pg_wal_reply_lsn", `pg_wal_reply_lsn`),
	qDB("pg_wal_replay_paused", `pg_wal_replay_paused`),
	qDB("pg_wal_receiver_status", `pg_wal_receiver_status`),
	qDB("pg_wal_size_bytes", `pg_wal_size_bytes`),
	qDB("pg_replication_slot_retained_wal_bytes", `pg_replication_slot_retained_wal_bytes`, "slot", "active", "wal_status"),
	qDB("pg_wal_archived_segments_total", `pg_wal_archived_segments_total`, "job"),
	qDB("pg_wal_archive_failures_total", `pg_wal_archive_failures_total`, "job"),
	qDB("pg_wal_archiving_status", `pg_wal_archiving_status`),
	...
	qDB("pg_db_table_bloat_bytes", `pg_db_table_bloat_bytes`, "db"),
	qDB("pg_db_index_bloat_bytes", `pg_db_index_bloat_bytes`, "db"),
	qDB("pg_table_bloat_bytes", `pg_table_bloat_bytes`, "db", "table"),
	qDB("pg_index_bloat_bytes", `pg_index_bloat_bytes`, "db", "table", "index"),
	qDB("pg_table_dead_tuple_bytes", `pg_table_dead_tuple_bytes`, "db", "table"),
	qDB("pg_table_dead_tuples", `pg_table_dead_tuples`, "db", "table"),
	qDB("pg_table_live_tuples", `pg_table_live_tuples`, "db", "table"),
	qDB("pg_table_seconds_since_last_autovacuum", `pg_table_seconds_since_last_autovacuum`, "db", "table"),
	qDB("pg_table_setting", `pg_table_setting`, "db", "table", "autovacuum_disabled", "autovacuum_vacuum_scale_factor", "autovacuum_vacuum_threshold", "autovacuum_vacuum_cost_delay", "autovacuum_vacuum_cost_limit", "autovacuum_analyze_scale_factor", "autovacuum_analyze_threshold"),
	qDB("pg_autovacuum_workers", `pg_autovacuum_workers`),
	qDB("pg_table_vacuum_in_progress", `pg_table_vacuum_in_progress`, "db", "table"),
	qDB("pg_table_vacuum_throttled", `pg_table_vacuum_throttled`, "db", "table"),
	qDB("pg_table_mods_since_analyze", `pg_table_mods_since_analyze`, "db", "table"),
	qDB("pg_table_reltuples", `pg_table_reltuples`, "db", "table"),
	qDB("pg_table_seconds_since_last_analyze", `pg_table_seconds_since_last_analyze`, "db", "table"),
	qDB("pg_checkpoints_scheduled_total", `pg_checkpoints_scheduled_total`, "type", "job"),
	qDB("pg_checkpoints_total", `pg_checkpoints_total`, "job"),
	qDB("pg_restartpoints_total", `pg_restartpoints_total`, "job"),
	qDB("pg_buffers_written_total", `rate(pg_buffers_written_total[$RANGE])`, "source"),
	qDB("pg_time_since_last_checkpoint_seconds", `pg_time_since_last_checkpoint_seconds`),
	qDB("pg_wal_since_last_checkpoint_bytes", `pg_wal_since_last_checkpoint_bytes`),
	...
	qDB("mysql_table_size_growth_bytes_per_second", `mysql_table_size_growth_bytes_per_second`, "db", "table"),
	qDB("mysql_connection_errors_max_connections_total", `rate(mysql_connection_errors_max_connections_total[$RANGE])`),
	qDB("mysql_threads_running", `mysql_threads_running`),
	qDB("mysql_innodb_transaction_seconds", `mysql_innodb_transaction_seconds`, "query"),
	qDB("mysql_top_query_rows_examined_per_second", `mysql_top_query_rows_examined_per_second`, "schema", "query"),
	qDB("mysql_top_query_rows_sent_per_second", `mysql_top_query_rows_sent_per_second`, "schema", "query"),
	qDB("mysql_created_tmp_disk_tables_total", `rate(mysql_created_tmp_disk_tables_total[$RANGE])`),
	qDB("mysql_wsrep_cluster_size", `mysql_wsrep_cluster_size`),
	qDB("mysql_wsrep_cluster_status", `mysql_wsrep_cluster_status`, "status"),
	qDB("mysql_wsrep_local_state", `mysql_wsrep_local_state`, "state"),
	qDB("mysql_wsrep_ready", `mysql_wsrep_ready`),
	qDB("mysql_wsrep_connected", `mysql_wsrep_connected`),
	qDB("mysql_wsrep_flow_control_paused_seconds_total", `rate(mysql_wsrep_flow_control_paused_seconds_total[$RANGE])`),
	qDB("mysql_wsrep_local_recv_queue", `mysql_wsrep_local_recv_queue`),
	qDB("mysql_wsrep_local_send_queue", `mysql_wsrep_local_send_queue`),
	qDB("mysql_wsrep_local_cert_failures_total", `rate(mysql_wsrep_local_cert_failures_total[$RANGE])`),
	qDB("mysql_wsrep_local_bf_aborts_total", `rate(mysql_wsrep_local_bf_aborts_total[$RANGE])`),
	qDB("mysql_group_replication_cluster_size", `mysql_group_replication_cluster_size`),
	qDB("mysql_group_replication_members_online", `mysql_group_replication_members_online`),
	qDB("mysql_group_replication_member_state", `mysql_group_replication_member_state`, "state"),
	qDB("mysql_group_replication_transactions_in_queue", `mysql_group_replication_transactions_in_queue`),
	qDB("mysql_group_replication_transactions_remote_in_applier_queue", `mysql_group_replication_transactions_remote_in_applier_queue`),
	qDB("mysql_group_replication_conflicts_detected_total", `rate(mysql_group_replication_conflicts_detected_total[$RANGE])`),
	qDB("mysql_innodb_buffer_pool_read_requests_total", `rate(mysql_innodb_buffer_pool_read_requests_total[$RANGE])`),
	qDB("mysql_innodb_buffer_pool_reads_total", `rate(mysql_innodb_buffer_pool_reads_total[$RANGE])`),
	qDB("mysql_innodb_buffer_pool_write_requests_total", `rate(mysql_innodb_buffer_pool_write_requests_total[$RANGE])`),
	qDB("mysql_innodb_buffer_pool_pages_total", `mysql_innodb_buffer_pool_pages_total`),
	qDB("mysql_innodb_buffer_pool_pages_free", `mysql_innodb_buffer_pool_pages_free`),
	qDB("mysql_innodb_buffer_pool_pages_dirty", `mysql_innodb_buffer_pool_pages_dirty`),
	qDB("mysql_innodb_buffer_pool_pages_data", `mysql_innodb_buffer_pool_pages_data`),
	qDB("mysql_innodb_buffer_pool_wait_free_total", `rate(mysql_innodb_buffer_pool_wait_free_total[$RANGE])`),
	qDB("mysql_innodb_buffer_pool_pages_flushed_total", `rate(mysql_innodb_buffer_pool_pages_flushed_total[$RANGE])`),
	qDB("mysql_innodb_page_size_bytes", `mysql_innodb_page_size_bytes`),
	qDB("mysql_innodb_rows_read_total", `rate(mysql_innodb_rows_read_total[$RANGE])`),
	qDB("mysql_innodb_rows_inserted_total", `rate(mysql_innodb_rows_inserted_total[$RANGE])`),
	qDB("mysql_innodb_rows_updated_total", `rate(mysql_innodb_rows_updated_total[$RANGE])`),
	qDB("mysql_innodb_rows_deleted_total", `rate(mysql_innodb_rows_deleted_total[$RANGE])`),
	qDB("mysql_innodb_row_lock_waits_total", `rate(mysql_innodb_row_lock_waits_total[$RANGE])`),
	qDB("mysql_innodb_row_lock_time_seconds_total", `rate(mysql_innodb_row_lock_time_seconds_total[$RANGE])`),
	qDB("mysql_innodb_row_lock_current_waits", `mysql_innodb_row_lock_current_waits`),
	qDB("mysql_innodb_data_reads_total", `rate(mysql_innodb_data_reads_total[$RANGE])`),
	qDB("mysql_innodb_data_writes_total", `rate(mysql_innodb_data_writes_total[$RANGE])`),
	qDB("mysql_innodb_data_read_bytes_total", `rate(mysql_innodb_data_read_bytes_total[$RANGE])`),
	qDB("mysql_innodb_data_written_bytes_total", `rate(mysql_innodb_data_written_bytes_total[$RANGE])`),
	qDB("mysql_innodb_data_fsyncs_total", `rate(mysql_innodb_data_fsyncs_total[$RANGE])`),
	qDB("mysql_innodb_log_waits_total", `rate(mysql_innodb_log_waits_total[$RANGE])`),
	qDB("mysql_innodb_os_log_written_bytes_total", `rate(mysql_innodb_os_log_written_bytes_total[$RANGE])`),
	qDB("mysql_sort_merge_passes_total", `rate(mysql_sort_merge_passes_total[$RANGE])`),
	qDB("mysql_commit_total", `rate(mysql_commit_total[$RANGE])`),
	qDB("mysql_rollback_total", `rate(mysql_rollback_total[$RANGE])`),
	qDB("mysql_innodb_deadlocks_total", `rate(mysql_innodb_deadlocks_total[$RANGE])`),
	qDB("mysql_innodb_lock_wait_timeouts_total", `rate(mysql_innodb_lock_wait_timeouts_total[$RANGE])`),
	qDB("mysql_innodb_history_list_length", `mysql_innodb_history_list_length`),
	qDB("mysql_binlog_size_bytes", `mysql_binlog_size_bytes`),
	qDB("mysql_binlog_files", `mysql_binlog_files`),
	qDB("mysql_binlog_expire_seconds", `mysql_binlog_expire_seconds`),
	qDB("mysql_undo_size_bytes", `mysql_undo_size_bytes`),
	qDB("mysql_table_locks_waited_total", `rate(mysql_table_locks_waited_total[$RANGE])`),
	qDB("mysql_table_locks_immediate_total", `rate(mysql_table_locks_immediate_total[$RANGE])`),
	...
	qDB("mongo_info", `mongo_info`, "server_version", "flavor"),
	...
	qDB("mongo_rs_member_status", `mongo_rs_member_status`, "rs", "member", "state"),
	qDB("mongo_rs_member_replication_lag_seconds", `mongo_rs_member_replication_lag_seconds`, "rs", "member"),
	qDB("mongo_rs_member_config_info", `mongo_rs_member_config_info`, "rs", "member", "arbiter", "votes"),
	qDB("mongo_rs_config_info", `mongo_rs_config_info`, "rs", "write_concern_majority_journal_default"),
	qDB("mongo_profiling_level", `mongo_profiling_level`, "db"),
	qDB("mongo_oplog_window_seconds", `mongo_oplog_window_seconds`),
	qDB("mongo_oplog_size_bytes", `mongo_oplog_size_bytes`),
	qDB("mongo_oplog_max_size_bytes", `mongo_oplog_max_size_bytes`),
	qDB("mongo_connections_current", `mongo_connections_current`),
	qDB("mongo_connections_active", `mongo_connections_active`),
	qDB("mongo_connections_max", `mongo_connections_max`),
	qDB("mongo_connections_created_total", `rate(mongo_connections_created_total[$RANGE])`),
	qDB("mongo_connections_rejected_total", `rate(mongo_connections_rejected_total[$RANGE])`),
	qDB("mongo_connections_by_app", `mongo_connections_by_app`, "app"),
	qDB("mongo_open_transactions", `mongo_open_transactions`, "app"),
	qDB("mongo_opcounters_total", `rate(mongo_opcounters_total[$RANGE])`, "op"),
	qDB("mongo_documents_returned_total", `rate(mongo_documents_returned_total[$RANGE])`),
	qDB("mongo_op_latency_seconds_total", `rate(mongo_op_latency_seconds_total[$RANGE])`, "type"),
	qDB("mongo_op_latency_ops_total", `rate(mongo_op_latency_ops_total[$RANGE])`, "type"),
	qDB("mongo_queued_operations", `mongo_queued_operations`, "type"),
	qDB("mongo_wt_tickets_available", `mongo_wt_tickets_available`, "type"),
	qDB("mongo_wt_cache_used_bytes", `mongo_wt_cache_used_bytes`),
	qDB("mongo_wt_cache_dirty_bytes", `mongo_wt_cache_dirty_bytes`),
	qDB("mongo_wt_cache_max_bytes", `mongo_wt_cache_max_bytes`),
	qDB("mongo_wt_pages_evicted_by_app_threads_total", `rate(mongo_wt_pages_evicted_by_app_threads_total[$RANGE])`),
	qDB("mongo_wt_app_threads_evicting_seconds_total", `rate(mongo_wt_app_threads_evicting_seconds_total[$RANGE])`),
	qDB("mongo_wt_checkpoints_total", `rate(mongo_wt_checkpoints_total[$RANGE])`),
	qDB("mongo_wt_checkpoint_seconds_total", `rate(mongo_wt_checkpoint_seconds_total[$RANGE])`),
	qDB("mongo_wt_journal_bytes_written_total", `rate(mongo_wt_journal_bytes_written_total[$RANGE])`),
	qDB("mongo_wt_journal_bytes_since_checkpoint", `mongo_wt_journal_bytes_since_checkpoint`),
	qDB("mongo_time_since_last_checkpoint_seconds", `mongo_time_since_last_checkpoint_seconds`),
	qDB("mongo_scanned_keys_total", `rate(mongo_scanned_keys_total[$RANGE])`),
	qDB("mongo_scanned_documents_total", `rate(mongo_scanned_documents_total[$RANGE])`),
	qDB("mongo_collection_scans_total", `rate(mongo_collection_scans_total[$RANGE])`),
	qDB("mongo_scan_and_order_total", `rate(mongo_scan_and_order_total[$RANGE])`),
	qDB("mongo_ttl_deleted_documents_total", `rate(mongo_ttl_deleted_documents_total[$RANGE])`),
	qDB("mongo_flow_control_time_acquiring_seconds_total", `rate(mongo_flow_control_time_acquiring_seconds_total[$RANGE])`),
	qDB("mongo_write_conflicts_total", `rate(mongo_write_conflicts_total[$RANGE])`),
	qDB("mongo_wt_cache_bytes_read_into_total", `rate(mongo_wt_cache_bytes_read_into_total[$RANGE])`),
	qDB("mongo_repl_apply_ops_total", `rate(mongo_repl_apply_ops_total[$RANGE])`),
	qDB("mongo_repl_buffer_operations", `mongo_repl_buffer_operations`),
	qDB("mongo_repl_buffer_bytes", `mongo_repl_buffer_bytes`),
	qDB("mongo_cursors_open", `mongo_cursors_open`),
	qDB("mongo_cursors_open_no_timeout", `mongo_cursors_open_no_timeout`),
	qDB("mongo_cursors_timed_out_total", `rate(mongo_cursors_timed_out_total[$RANGE])`),
	qDB("mongo_fsync_locked", `mongo_fsync_locked`),
	qDB("mongo_prepared_transactions", `mongo_prepared_transactions`),
	qDB("mongo_top_query_calls_per_second", `mongo_top_query_calls_per_second`, "db", "collection", "query"),
	qDB("mongo_top_query_time_per_second", `mongo_top_query_time_per_second`, "db", "collection", "query"),
	qDB("mongo_top_query_docs_returned_per_second", `mongo_top_query_docs_returned_per_second`, "db", "collection", "query"),
	qDB("mongo_top_query_docs_examined_per_second", `mongo_top_query_docs_examined_per_second`, "db", "collection", "query"),
	qDB("mongo_top_query_keys_examined_per_second", `mongo_top_query_keys_examined_per_second`, "db", "collection", "query"),
	qDB("mongo_operations_waiting_for_lock", `mongo_operations_waiting_for_lock`, "db"),
	qDB("mongo_long_running_operations", `mongo_long_running_operations`, "db", "collection", "query", "plan"),
	...
	qDB("mongo_collection_storage_size_bytes", `mongo_collection_storage_size_bytes`, "db", "collection"),
	qDB("mongo_collection_size_growth_bytes_per_second", `mongo_collection_size_growth_bytes_per_second`, "db", "collection"),
	qDB("mongo_collection_free_storage_bytes", `mongo_collection_free_storage_bytes`, "db", "collection"),
	qDB("mongo_collection_documents", `mongo_collection_documents`, "db", "collection"),
	...
	qPod("pg_backup_target_info", `pg_backup_target_info`, "name", "namespace", "operator", "method", "path", "endpoint", "s3_bucket", "s3_endpoint", "gcs_bucket", "azure_container", "schedule", "retention_policy"),
	qPod("pg_cluster_status", `pg_cluster_status`, "name", "namespace", "operator", "type", "status", "reason"),
	qPod("pg_backup_last_successful_timestamp_seconds", `pg_backup_last_successful_timestamp_seconds`, "name", "namespace", "operator", "method"),
	qPod("pg_backup_first_recoverability_point_timestamp_seconds", `pg_backup_first_recoverability_point_timestamp_seconds`, "name", "namespace", "operator", "method"),
	qPod("pg_backup_last_failed_timestamp_seconds", `pg_backup_last_failed_timestamp_seconds`, "name", "namespace", "operator"),
	qPod("pg_backup_schedule_info", `pg_backup_schedule_info`, "name", "namespace", "operator", "cluster", "schedule"),
	qPod("pg_backup_next_scheduled_timestamp_seconds", `pg_backup_next_scheduled_timestamp_seconds`, "name", "namespace", "operator", "cluster"),
	qPod("pg_backup_info", `pg_backup_info`, "name", "namespace", "operator", "cluster", "method", "kind", "path"),
	qPod("pg_backup_status", `pg_backup_status`, "name", "namespace", "operator", "status"),
	qPod("pg_backup_completed_timestamp_seconds", `pg_backup_completed_timestamp_seconds`, "name", "namespace", "operator", "cluster"),

	qPod("mongo_backup_target_info", `mongo_backup_target_info`, "name", "namespace", "operator", "method", "s3_bucket", "s3_endpoint", "s3_prefix", "azure_container"),
	qPod("mongo_backup_schedule_info", `mongo_backup_schedule_info`, "name", "namespace", "operator", "task", "schedule", "method", "kind", "enabled"),
	qPod("mongo_backup_pitr_info", `mongo_backup_pitr_info`, "name", "namespace", "operator", "enabled"),
	qPod("mongo_cluster_status", `mongo_cluster_status`, "name", "namespace", "operator", "status"),
	qPod("mongo_backup_info", `mongo_backup_info`, "name", "namespace", "operator", "cluster", "method", "kind", "path"),
	qPod("mongo_backup_status", `mongo_backup_status`, "name", "namespace", "operator", "status"),
	qPod("mongo_backup_completed_timestamp_seconds", `mongo_backup_completed_timestamp_seconds`, "name", "namespace", "operator"),

	qPod("mysql_backup_target_info", `mysql_backup_target_info`, "name", "namespace", "operator", "method", "s3_bucket", "s3_endpoint", "s3_prefix", "azure_container"),
	qPod("mysql_backup_schedule_info", `mysql_backup_schedule_info`, "name", "namespace", "operator", "task", "schedule", "method"),
	qPod("mysql_backup_pitr_info", `mysql_backup_pitr_info`, "name", "namespace", "operator", "enabled"),
	qPod("mysql_cluster_status", `mysql_cluster_status`, "name", "namespace", "operator", "status"),
	qPod("mysql_backup_info", `mysql_backup_info`, "name", "namespace", "operator", "cluster", "method", "kind", "path"),
	qPod("mysql_backup_status", `mysql_backup_status`, "name", "namespace", "operator", "status"),
	qPod("mysql_backup_completed_timestamp_seconds", `mysql_backup_completed_timestamp_seconds`, "name", "namespace", "operator"),
}
