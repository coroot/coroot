...
var QUERIES = map[string]string{
	...
	"container_http_requests_latency":        `rate(container_http_request_duration_seconds_total_sum [$RANGE]) / rate(container_http_request_duration_seconds_total_count [$RANGE])`,
	"container_http_requests_histogram":      `rate(container_http_request_duration_seconds_total_bucket[$RANGE])`,
	...
	"container_postgres_requests_histogram":  `rate(container_postgres_request_duration_seconds_total_bucket[$RANGE])`,
	...
	"container_redis_requests_histogram":     `rate(container_redis_request_duration_seconds_total_bucket[$RANGE])`,
	...
	"container_memcached_requests_histogram": `rate(container_memcached_request_duration_seconds_total_bucket[$RANGE])`,
	...
	"container_mysql_requests_histogram":     `rate(container_mysql_request_duration_seconds_total_bucket[$RANGE])`,
	...
	"container_mongo_requests_histogram":     `rate(container_mongo_request_duration_seconds_total_bucket[$RANGE])`,
