            ...
            <td>
                <div v-if="form.configs[2] !== null" class="d-flex align-center">
                    <div class="flex-grow-1 capfirst py-3">
                        ...
                        <v-text-field outlined hide-details v-model.number="form.configs[2].threshold" :rules="[$validators.isFloat]" class="input" />
                        {{unit}} {{condition.tail}}
                    </div>
                    <!-- eslint-disable-next-line vue/no-mutating-props -->
                ...
                <div v-else class="grey--text">
                    The project-level override &darr; is used. <a @click="override(2)">Override</a>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div v-if="form.configs[1] !== null" class="d-flex align-center">
                    <div class="flex-grow-1 capfirst py-3">
                        {{condition.head}}
                        <!-- eslint-disable-next-line vue/no-mutating-props -->
                        <v-text-field outlined hide-details v-model.number="form.configs[1].threshold" :rules="[$validators.isFloat]" class="input" />
                        {{unit}} {{condition.tail}}
                    </div>
                    <!-- eslint-disable-next-line vue/no-mutating-props -->
                ...
                <div v-else class="grey--text">
                    The global default &darr; is used. <a @click="override(1)">Override</a>
                </div>
            </td>
        </tr>
        <tr>
